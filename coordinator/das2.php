...
<!--Total Number College-->                                
                                <center>
                                  <div class="col-lg-6 col-md-6">
                                      <div class="pd-100 card-box border" style="background-color: #3b5998 !important;">
                                      <br>
                                      <h4><span style="color: #ff4081;font-size: 35px;width: 120px">25</span></h4>
                                  ...
                                  <div class=" col-sm-12 mb-30 row">    
                                    <div class="col-lg-6 col-md-6">
                                      ...
                                      <div class="progress mb-20">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 40%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">50</div>
                                        </div>
                                        <br>
                                      </div>
                                    </div>  
...
<!-- Approve,Pendind,Disapprove-->
                                    ...
                                    <div class="row clearfix progress-box" style="justify-content:center;">
                                      <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                                        <div class="card-box pd-30 height-100-p border" style="background-color: #3b5998 !important;">
...
<!--Po-->                             
                                  <center>
                                  <div class="col-lg-6 col-md-6">
                                      <div class="pd-100 card-box border" style="background-color: #00a0d1 !important">
                                      <br>
