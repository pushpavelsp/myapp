...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="po_officer.php">Programme Officer</a></li>
    <li class="breadcrumb-item active" aria-current="page" href="view_po_officer.php">Programme Officer Details</li>
  </ol>
</nav>
